...
impl MarkerExpression {
    ...
    /// # use std::collections::HashSet;
    /// # use std::str::FromStr;
    /// # use pep508_rs::{ExtraName, MarkerTree, Pep508Error};
    ...
    fn warnings4() {
        ...
        logs_assert(|lines: &[&str]| {
            let lines: Vec<_> = lines
                ...
                .collect();
            let expected = [
                "WARN warnings4: pep508_rs::marker: os.name is deprecated in favor of os_name",
                "WARN warnings4: pep508_rs::marker: platform.machine is deprecated in favor of platform_machine",
                "WARN warnings4: pep508_rs::marker: platform.python_implementation is deprecated in favor of platform_python_implementation",
                "WARN warnings4: pep508_rs::marker: platform.version is deprecated in favor of platform_version",
                "WARN warnings4: pep508_rs::marker: sys.platform  is deprecated in favor of sys_platform"
            ];
            if lines == expected {
                Ok(())
            } else {
